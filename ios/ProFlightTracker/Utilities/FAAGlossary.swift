...
enum FAAGlossary {
    ...
    static let terms: [String: GlossaryEntry] = [
        ...
        "CTOT": GlossaryEntry(term: "CTOT", name: "Calculated Take-Off Time",
            definition: "A Eurocontrol slot — the exact minute a flight is allowed to take off so it arrives in European airspace when the system can accept it. Missing the slot usually means a new, later CTOT."),
        "G-AIRMET": GlossaryEntry(term: "G-AIRMET", name: "Graphical AIRMET",
            definition: "A mapped forecast of moderate turbulence, icing, or low-level wind shear. Less severe than a SIGMET, but the polygons traffic management watches along a route."),
        "GAIRMET": GlossaryEntry(term: "G-AIRMET", name: "Graphical AIRMET",
            definition: "A mapped forecast of moderate turbulence, icing, or low-level wind shear. Less severe than a SIGMET, but the polygons traffic management watches along a route."),
